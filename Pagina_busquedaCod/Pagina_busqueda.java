...
public class Pagina_busqueda extends JFrame {
	...
	//------------------------------------------------------------------------------------------------------------	
		lblTexto_informativo = new JLabel("<html><p style=\"color: #000000, text-align:center;\"> ¿Buscas un programa o una película en particular?<br>"//USO DE HTML PARA DARLE FORMA AL TEXTO, AÑADIMOS EL COLOR NEGRO PARA QUE SEA MÁS INTENSO
				...
				+ " ►El título de una película<br><br> ►El nombre de una cancíon o álbum<br><br><br>"
	...
	//------------------------------------------------------------------------------------------------------------		
		...
		//------------------------------------------------------------------------------------------------------------		
			lblEnlace_Anuncio1 = new JLabel("anuncio1");
		...
		//------------------------------------------------------------------------------------------------------------
			lblEnlace_Anuncio2 = new JLabel("anuncio2");
		...
		//------------------------------------------------------------------------------------------------------------
			lblEnlace_Anuncio3 = new JLabel("anuncio3");
	...
	//------------------------------------------------------------------------------------------------------------
		...
		comboBox_Ordenar.setBounds(813, 126, 121, 20);
	//------------------------------------------------------------------------------------------------------------	
	//btnBuscar EL BOTÓN DE BUSCAR
	//------------------------------------------------------------------------------------------------------------
		btnBuscar = new JButton("BUSCAR");
		btnBuscar.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnBuscar.setBounds(813, 86, 123, 28);
	//------------------------------------------------------------------------------------------------------------	
	...
	//------------------------------------------------------------------------------------------------------------	
		...
		text_Barra_busqueda.setBounds(468, 86, 347, 29);
	//------------------------------------------------------------------------------------------------------------	
	...
	//------------------------------------------------------------------------------------------------------------					
		...
		ImageIcon imgfondologo = new ImageIcon(logo.getImage().getScaledInstance(lbl_Logo.getWidth(), lbl_Logo.getHeight(), Image.SCALE_SMOOTH)); // CREAMOS OTRO OBJETO PARA QUE SE AJUSTE AUTOMATICAMENTE LA IMAGEN AL LABEL
