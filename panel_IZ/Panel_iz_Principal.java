 ...
 * @param panelLateral
 * Es el panel que interaciona como desplegable cambiando su tamaño y nos da la funcionalidad de agrandar la pantalla para las personas con dificultad y realizar las tareas de salir de la aplicación e ir a las demas pantallas.
 * @param btn_Salir
 *  btn_Salir te permite cerrar la aplicación.
 * @param btn_BuscarLateral 
 * El botón de btn_BuscarLateral te enviara a una página donde podras buscar la película, serie o música que quieras mediante el nombre.
 * @param btn_Musica 
 * El botón de btn_Musica te mostrara una págian donde podras escuchar canciones o albumes.
 * @param btn_Peliculas 
 * El botón de btn_Peliculas te mostrara una págian donde podras ver películas.
 * @param btn_Series 
 * El botón de btn_Series te mostrara una págian donde podras ver series y capítulos de dicha serie.
 * @param btn_LogoOriginal 
 * El botón de btn_LogoOriginal te enviara al la pantalla que se muestra al principio donde te mostrara publicidad y una recomendación.
 * @param lbl_FleDesple 
 ...
 * @param desktopPane 
 * El desktopPane es el componente que nos permite intercambiar paneles sin tener que habrir una ventana entera solo cargando el panel.
 * @param btn_Diamante 
 * El botón de btn_Diamante te mostrara una págian donde podras escuchar música, ver series y ver pelícilas.
 * @param diamante 
 * diamante es un objeto que pertenece a la clase Diamante_premium.
 * @param diamante2 
 * diamante2 es un objeto que pertenece a la clase Diamante_premium2.
 * @param publicidad 
 * publicidad es un objeto que pertenece a la clase Pagina_Publicidad.
 * @param publicidad2 
 * publicidad2 es un objeto que pertenece a la clase Pagina_Publicidad2.
 * @param rubi 
 * rubi es un objeto que pertenece a la clase Inicio_RubiStandar.
 * @param rubi2 
 * rubi2 es un objeto que pertenece a la clase Inicio_RubiStandar2.
 * @param zafiro 
 * zafiro es un objeto que pertenece a la clase inicio_ZafiroStandar.
 * @param zafiro2 
 * zafiro2 es un objeto que pertenece a la clase inicio_ZafiroStandar2.
 * @param p_musica 
 * p_musica es un objeto que pertenece a la clase Cristal_Basic.
 * @param p_musica2 
 * p_musica2 es un objeto que pertenece a la clase Cristal_Basic2.
 * @param  buscar
 * buscar es un objeto que pertenece a la clase Pagina_busqueda.
 * @param  buscar2
 * buscar2 es un objeto que pertenece a la clase Pagina_busqueda2.
 * @param desactivar 
 * El boolean desactivar es un comprobador si se ha pulsado el botón btn_LogoOriginal o no (por defecto desactivar esta a false y cuando pulsas el botón btn_LogoOriginal se vuelve a true).
 * @param tamBigPelis 
 * El boolean tamBigPelis es un comprobador del tamaño que hay para poner el panel correspondiente (por defecto tamBigPelis esta a false panel pequeño y cuando pulsas el lbl_FleDesple se vuelve a true que es el tamaño del panel grande).
 * @param tamBigSeries 
 * El boolean tamBigSeries es un comprobador del tamaño que hay para poner el panel correspondiente (por defecto tamBigSeries esta a false panel pequeño y cuando pulsas el lbl_FleDesple se vuelve a true que es el tamaño del panel grande).
 * @param tamBigMusica 
 * El boolean tamBigMusica es un comprobador del tamaño que hay para poner el panel correspondiente (por defecto tamBigMusica esta a false panel pequeño y cuando pulsas el lbl_FleDesple se vuelve a true que es el tamaño del panel grande).
 * @param tamBigBusqueda 
 * El boolean tamBigBusqueda es un comprobador del tamaño que hay para poner el panel correspondiente (por defecto tamBigBusqueda esta a false panel pequeño y cuando pulsas el lbl_FleDesple se vuelve a true que es el tamaño del panel grande).
 * @param tamBigDiamante 
 * El boolean tamBigDiamante es un comprobador del tamaño que hay para poner el panel correspondiente (por defecto tamBigDiamante esta a false panel pequeño y cuando pulsas el lbl_FleDesple se vuelve a true que es el tamaño del panel grande).
 * @param comprobarPelis 
 * El boolean comprobarPelis es un comprobador si se ha pulsado el botón btn_Peliculas o no (por defecto comprobarPelis esta a false y cuando pulsas el botón btn_Peliculas se vuelve a true).
 * @param comprobarSeries 
 * El boolean comprobarSeries es un comprobador si se ha pulsado el botón btn_Series o no (por defecto comprobarSeries esta a false y cuando pulsas el botón btn_Series se vuelve a true).
 * @param comprobarMusica 
 * El boolean comprobarMusica es un comprobador si se ha pulsado el botón btn_Musica o no (por defecto comprobarMusica esta a false y cuando pulsas el botón btn_Musica se vuelve a true).
 * @param comprobarBusqueda 
 * El boolean comprobarBusqueda es un comprobador si se ha pulsado el botón btn_BuscarLateral o no (por defecto comprobarBusqueda esta a false y cuando pulsas el botón btn_BuscarLateral se vuelve a true).
 * @param comprobarPublicadaGrande 
 * El boolean comprobarPublicadaGrande es un comprobador del tamaño que hay para poner el panel correspondiente (por defecto comprobarPublicadaGrande esta a true panel pequeño y cuando pulsas el lbl_FleDesple se vuelve a false que es el tamaño del panel grande).
 * @param comprobarDiamante 
 * El boolean comprobarDiamante es un comprobador si se ha pulsado el botón btn_Diamante o no (por defecto comprobarDiamante esta a false y cuando pulsas el botón btn_Diamante se vuelve a true).
...
public class Panel_iz_Principal extends JFrame {
	...
	private boolean tamBigCristal=false;
	public static boolean comprobarPelis=false;
	private boolean comprobarSeries=false;
	private boolean comprobarMusica=false;
	...
	public static boolean comprobarCristal=false;
	...
	// -----------------------------------------------------------------------------------------------------
	/**
	 * En este metodo se intercambiara el panel seleccionado por el que estaba pero en el tamaño pequeño.
	...
	// -----------------------------------------------------------------------------------------------------
	/**
	 * En este metodo se intercambiara el panel seleccionado por el que estaba pero en el tamaño grande.
	 * @param panelNuevo es un atributo que se le pasara por parametro para intercambiar los paneles en el desktopPane.
	 */
	...
	// -----------------------------------------------------------------------------------------------------
	/**
	 * En este metodo se elimina todos los paneles del desktopPane.
	 */
	...
	// -----------------------------------------------------------------------------------------------------
	/**
	 * El constructor se llama a los atributos y metodos necesarios para el funcionamiento de la clase Panel_iz_Principal.
	 */
			...
			public void mouseClicked(MouseEvent e) {
				if (panelLateral.getBounds().width == 219) {
					...
					if (comprobarPublicadaGrande==false && desactivar==false){
						...
						tamBigDiamante=false;
					} else if(comprobarCristal==true && tamBigCristal==true ) {
						eliminar();
						nuevoPanel2(p_musica2.getPanel_CristalBasic());
